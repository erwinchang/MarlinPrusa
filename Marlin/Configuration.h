...
#define STRING_CONFIG_H_AUTHOR "3DPW Taiwan" // Who made the changes.
...
#define HOMING_FEEDRATE {70*60, 70*60, 4*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {98.2,98.2,400.0,96.0}  // default steps per unit for Ultimaker
